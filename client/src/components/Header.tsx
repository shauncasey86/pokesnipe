...
export default function Header({
  ...
  const isPaused = scannerStatus === 'paused';
    ...
    <>
      <header className="header glass-static">
        <div className="header-inner">
          ...
          {/* Right zone: Actions — always rendered when authenticated */}
          {isAuthenticated && (
            <div className="header-actions">
              ...
              {onToggleScanner && (
                <button
                  className="header-btn scanner-toggle"
                  onClick={onToggleScanner}
                  title={isPaused ? 'Start Scanner' : 'Pause Scanner'}
                  style={{
                    borderColor: isPaused ? 'var(--amber)' : 'var(--green)',
